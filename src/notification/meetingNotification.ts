...
export const createNewMeetingNotificationJob = (data: NewMeetingNotificationData) => {
  ...
  return {
    ...
    message: `You have received a meeting invitation from **${organizer_full_name}** for **${project_title}**`,
    params: {
      meeting_event_id,
    },
    recipient_id,
...
export const createUpdateMeetingNotificationJob = (data: UpdateMeetingNotificationData) => {
  ...
  return {
    ...
    message: `**${organizer_full_name}** has updated meeting information for project **${project_title}**`,
    params: {
      meeting_event_id,
    },
    recipient_id,
