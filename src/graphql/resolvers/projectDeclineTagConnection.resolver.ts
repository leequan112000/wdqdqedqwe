...
const resolvers: Resolvers<Context> = {
  ProjectDeclineTagConnection: {
    project_decline_tag: async (parent, _, context) => {
      invariant(parent.project_decline_tag_id, 'Project decline tag id not found');
    ...
    project_decline_feedback: async (parent, _, context) => {
      invariant(parent.project_decline_feedback_id, 'Project decline feedback id not found.');
