...
import {
  contractUploadNoticeTemplate,
  contractUpdateNoticeTemplate,
  documentUploadNoticeTemplate,
} from './templates';
...
export const documentUploadNoticeEmail = async (
...
export const bulkDocumentUploadNoticeEmail = async (
  data: BulkDocumentUploadNoticeEmailData[],
) => {
...
export const contractUploadNoticeEmail = async (
...
export const bulkContractUploadNoticeEmail = async (
  data: BulkContractUploadNoticeEmailData[],
) => {
...
export const contractUpdateNoticeEmail = async (
...
export const bulkContractUpdateNoticeEmail = async (
  data: BulkContractUpdateNoticeEmailData[],
) => {
  const bulks = createBulkEmailJobData(data, contractUploadNoticeTemplate);
  createBulkSendMailJobs(bulks);
};
